package com.titanfallmod.entity;
...
public class Atlas extends EntityAnimal implements IInvBasic
{
    private static final IEntitySelector horseBreedingSelector = new IEntitySelector()
    {
        ...
        {
            return par1Entity instanceof Atlas && ((Atlas)par1Entity).func_110205_ce();
        }
    };
    ...
    protected Atlas getClosestHorse(Entity par1Entity, double par2)
    {
    ...
    public void displayGUIHorse(Atlas par1EntityHorse, IInventory par2IInventory) {}
    public void openGUI(EntityPlayer par1EntityPlayer)
    {
        ...
        {
            this.horseChest.func_110133_a(this.getCommandSenderName());
            this.displayGUIHorse(this, this.horseChest);
        }
    }
    ...
    public void onLivingUpdate()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                Atlas entityhorse = this.getClosestHorse(this, 16.0D);
    ...
    public boolean canMateWith(EntityAnimal par1EntityAnimal)
    {
        ...
        {
            Atlas entityhorse = (Atlas)par1EntityAnimal;
    ...
    {
        Atlas entityhorse = (Atlas)par1EntityAgeable;
        Atlas entityhorse1 = new Atlas(this.worldObj);
        int i = this.getHorseType();
        int j = entityhorse.getHorseType();
        int k = 0;
        ...
        entityhorse1.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(d2 / 3.0D);
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData par1EntityLivingData)
    {
        ...
        if (par1EntityLivingData1 instanceof Atlas.GroupData)
        {
            l = ((Atlas.GroupData)par1EntityLivingData1).field_111107_a;
            i = ((Atlas.GroupData)par1EntityLivingData1).field_111106_b & 255 | this.rand.nextInt(5) << 8;
        }
        else
        {
            ...
            par1EntityLivingData1 = new Atlas.GroupData(l, i);
        }
    ...
    public void updateRiderPosition()
    {
        ...
        if (this.prevRearingAmount > 0.0F)
        {
            ...
            float f3 = 0.9F * this.prevRearingAmount;
